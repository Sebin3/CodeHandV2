...
export default function InfiniteScroll({
  ...
  return (
    <div
      className="relative flex items-center justify-center w-full overscroll-none"
      ref={wrapperRef}
      style={{ maxHeight }}
    >
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center p-4 text-xl font-semibold text-center border-2 border-gray-300 rounded-[15px] select-none box-border relative bg-gray-50 text-gray-800"
            key={i}
            style={{
