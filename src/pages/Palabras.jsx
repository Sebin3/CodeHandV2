    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 flex items-center justify-center min-h-[calc(100vh-80px)]">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Módulo de Palabras</h1>
          <p className="text-lg text-gray-600">Forma palabras completas con lenguaje de señas</p>
        </div>
      </div>
    </div>
  );
